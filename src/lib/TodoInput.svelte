...
<form class="text-xl flex gap-2" on:submit|preventDefault={addTodo}>
	...
	class="grow min-w-0 px-8 py-4 rounded-md border-2 bg-transparent outline-none placeholder:font-light placeholder:text-lg placeholder:text-neutral-600 placeholder:dark:text-neutral-500 border-neutral-600 dark:border-neutral-600 focus:border-neutral-900 focus:dark:border-neutral-400">
